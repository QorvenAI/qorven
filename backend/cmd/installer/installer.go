...
`
	...
	case 10: // nginx reverse proxy (opt-in only)
		if cfg.SkipNginx {
...
// waitForHealth polls http://127.0.0.1:<port>/health until it responds 200 or
// the deadline is reached. Uses the port chosen during the install wizard.
