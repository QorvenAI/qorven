...
- For projects/products: use official name (e.g., "project-alpha", "qorven")
...
- project: initiatives, campaigns, programs being built or executed (Qorven, thesis, ad campaign)
...
Input: "Talked to Minh about the Qorven migration. He'll handle the database schema changes by Friday. The team uses PostgreSQL with pgvector. I wrote the migration guide yesterday."

Output:
{
  "entities": [
    {"external_id": "minh", "name": "Minh", "entity_type": "person", "description": "Handling database schema changes for Qorven", "confidence": 1.0},
    {"external_id": "qorven", "name": "Qorven", "entity_type": "project", "description": "Project undergoing migration", "confidence": 1.0},
    {"external_id": "qorven-migration", "name": "Qorven Migration", "entity_type": "task", "description": "Database migration task, deadline Friday", "confidence": 1.0},
    ...
    {"external_id": "migration-guide", "name": "Migration Guide", "entity_type": "document", "description": "Guide for the Qorven database migration", "confidence": 1.0}
  ],
  "relations": [
    {"source_entity_id": "minh", "relation_type": "assigned_to", "target_entity_id": "qorven-migration", "confidence": 1.0},
    {"source_entity_id": "qorven-migration", "relation_type": "part_of", "target_entity_id": "qorven", "confidence": 1.0},
    {"source_entity_id": "qorven", "relation_type": "uses", "target_entity_id": "postgresql", "confidence": 1.0},
    {"source_entity_id": "postgresql", "relation_type": "integrates_with", "target_entity_id": "pgvector", "confidence": 0.8},
    {"source_entity_id": "migration-guide", "relation_type": "references", "target_entity_id": "qorven-migration", "confidence": 1.0}
  ]
}`
