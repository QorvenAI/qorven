...
// AutoMode defines when TTS should be automatically applied.
type AutoMode string

const (
	AutoOff     AutoMode = "off"
	AutoInbound AutoMode = "inbound"
	AutoTagged  AutoMode = "tagged"
	AutoAlways  AutoMode = "always"
)

// Mode defines the scope of auto-apply.
type Mode string
...
// Options configures TTS synthesis.
type Options struct {
	Voice  string // voice name
	Model  string // model name
	Format string // output format (mp3, opus, wav, etc.)
}

// SynthResult contains the result of TTS synthesis.
